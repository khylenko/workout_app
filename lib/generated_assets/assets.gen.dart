...
class $LibConfigGen {
  ...
  $LibConfigTranslationsGen get translations =>
      const $LibConfigTranslationsGen();
}

class $LibConfigTranslationsGen {
  const $LibConfigTranslationsGen();

  /// File path: lib/config/translations/en.json
  String get en => 'lib/config/translations/en.json';

  /// File path: lib/config/translations/ru.json
  String get ru => 'lib/config/translations/ru.json';
